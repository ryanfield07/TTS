...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { brewery: @beer.brewery, comments: @beer.comments, date: @beer.date, name: @beer.name, rating: @beer.rating }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { brewery: @beer.brewery, comments: @beer.comments, date: @beer.date, name: @beer.name, rating: @beer.rating }
    assert_redirected_to beer_path(assigns(:beer))
  end
